    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    	...
    	http
                .authorizeHttpRequests(authorize -> authorize
                                .requestMatchers("/api/userinfo", "/api/addCourse", "/api/addVedio", "/api/addTasks","/api/addData","/api/findCourse","/api/getCourse","/api/getVideos,/api/findCourseThumbnail,/api/findTaskImages").authenticated()  // Protect specific endpoints
